...
partial class FrmRegistreren
{
    ...
    private void InitializeComponent()
    {
        ...
        lbl_txtWachtwoord = new Label(); lbl_txtWachtwoord.Location = new Point(220,377); lbl_txtWachtwoord.Size = new Size(160,25); lbl_txtWachtwoord.Text = "Wachtwoord:";
        txtWachtwoord = new TextBox(); txtWachtwoord.Location = new Point(390,377); txtWachtwoord.Size = new Size(310,25); txtWachtwoord.UseSystemPasswordChar = true;
        lbl_txtWachtwoordHerhalen = new Label(); lbl_txtWachtwoordHerhalen.Location = new Point(220,419); lbl_txtWachtwoordHerhalen.Size = new Size(160,25); lbl_txtWachtwoordHerhalen.Text = "Wachtwoord herhalen:";
        txtWachtwoordHerhalen = new TextBox(); txtWachtwoordHerhalen.Location = new Point(390,419); txtWachtwoordHerhalen.Size = new Size(310,25); txtWachtwoordHerhalen.UseSystemPasswordChar = true;
        btnPrimary = new Button(); btnPrimary.Location = new Point(390,476); btnPrimary.Size = new Size(150,38); btnPrimary.Text = "Registreren"; btnPrimary.BackColor = Color.FromArgb(181, 32, 46); btnPrimary.ForeColor = Color.White; btnPrimary.FlatStyle = FlatStyle.Flat;
        btnAnnuleren = new Button(); btnAnnuleren.Location = new Point(550,476); btnAnnuleren.Size = new Size(150,38); btnAnnuleren.Text = "Annuleren";
        btnAnnuleren.Click += btnAnnuleren_Click;
        Controls.AddRange(new Control[] { lblTitel, lbl_txtVoornaam, txtVoornaam, lbl_txtTussenvoegsel, txtTussenvoegsel, lbl_txtAchternaam, txtAchternaam, lbl_dtpGeboortedatum, dtpGeboortedatum, lbl_txtTelefoonnummer, txtTelefoonnummer, lbl_txtEmail, txtEmail, lbl_txtWachtwoord, txtWachtwoord, lbl_txtWachtwoordHerhalen, txtWachtwoordHerhalen, btnPrimary, btnAnnuleren });
