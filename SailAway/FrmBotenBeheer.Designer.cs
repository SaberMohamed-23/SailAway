...
partial class FrmBotenBeheer
{
    ...
    private void InitializeComponent()
    {
        ...
        dgv.Columns.Add("Merk", "Merk");
        dgv.Columns.Add("Type", "Type");
        dgv.Columns.Add("Capaciteit", "Capaciteit");
        dgv.Columns.Add("Bouwjaar", "Bouwjaar");
        dgv.Columns.Add("Lengte", "Lengte");
        dgv.Columns.Add("Locatie", "Locatie");
        dgv.Columns.Add("Prijsperuur", "Prijs per uur");
        dgv.Rows.Add("Sea Star", "Yamaha", "Motorboot", "6", "2021", "7,5 m", "Veghel", "€60");
