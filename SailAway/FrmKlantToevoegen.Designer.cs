...
partial class FrmKlantToevoegen
{
    ...
    private void InitializeComponent()
    {
        ...
        btnPrimary = new Button(); btnPrimary.Location = new Point(390,392); btnPrimary.Size = new Size(150,38); btnPrimary.Text = "Toevoegen"; btnPrimary.BackColor = Color.FromArgb(181, 32, 46); btnPrimary.ForeColor = Color.White; btnPrimary.FlatStyle = FlatStyle.Flat;
